...
func main() {
	...
	http.HandleFunc("/api/email", func(w http.ResponseWriter, r *http.Request) {
		if r.Method == http.MethodPost {
			...
			sendMail(auth, smtpServer, smtpPort, username, password, to, userId)
...
func sendMail(auth smtp.Auth, smtpServer string, smtpPort string, username string, password string, to string, userId string) {
